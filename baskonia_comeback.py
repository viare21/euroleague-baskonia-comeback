...
header = pd.read_csv(r"C:\Users\Bologna\Desktop\anaconda\csv_euroleague\euroleague_header.csv")
pbp = pd.read_csv(r"C:\Users\Bologna\Desktop\anaconda\csv_euroleague\euroleague_play_by_play.csv")
...
table_home = [[16, 52 - 16], [217, 978 - 217]]
odds_ratio_home, p_value_fisher_home = fisher_exact(table_home)

table_away = [[17, 119 - 17], [213, 1864 - 213]]
...
baskonia_values = [30.8, 14.3]
league_values = [22.2, 11.4]
...
plt.tight_layout()
plt.savefig('images/baskonia_comeback_rate.png', dpi=150, facecolor=fig.get_facecolor(), pad_inches=0.3)
plt.show()